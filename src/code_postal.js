function grille(TCT_ADDRESSES, TCT_TRANSPORTATION_DURATION) {
  ...
  if(TCT_ADDRESSES.length === 0) {return { transportation: 0, handling: 0}};

  const postalCodes = [TCT_ADDRESSES[0].postalCode || '',
                       TCT_ADDRESSES[TCT_ADDRESSES.length - 1].postalCode || ''];
